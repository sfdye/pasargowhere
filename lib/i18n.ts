...
const en = {
  ...
  transitTime: '{min} min by transit',
  legWalk: '{min} min walk',
  legBus: 'Bus {route} · {stops} stops · {min} min',
  legBusNoStops: 'Bus {route} · {min} min',
  legTrain: '{route} · {stops} stops · {min} min',
  legTrainNoStops: '{route} · {min} min',
  enableLocationRoute: 'Enable location for route',
...
const zh: Record<keyof typeof en, string> = {
  ...
  modeTransit: '公交',
  walkTime: '步行 {min} 分钟',
  transitTime: '公交 {min} 分钟',
  legWalk: '步行 {min} 分钟',
  legBus: '公交 {route} · {stops} 站 · {min} 分钟',
  legBusNoStops: '公交 {route} · {min} 分钟',
  legTrain: '{route} · {stops} 站 · {min} 分钟',
  legTrainNoStops: '{route} · {min} 分钟',
  enableLocationRoute: '开启定位查看路线',
