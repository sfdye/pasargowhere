...
const en = {
  ...
  hoursNoteNoData: 'Hours are set by each stall and are not in the National Environment Agency (NEA) data — this covers whole-day closures only.',
  ...
  dataSourceLink: "Singapore's National Environment Agency (NEA)",
  ...
  source: 'Source code',
  feedback: 'Feedback',
  offline: "Showing saved data — could not reach Singapore's National Environment Agency (NEA).",
  ...
  showMore: 'Show more',
  showLess: 'Show less',
  marketNotFound: 'This market is no longer in the National Environment Agency (NEA) dataset.',
...
const zh: Record<keyof typeof en, string> = {
  ...
  hoursNoteMonday: '星期一是摊主自行休息的日子，并非官方休市——市场通常照常开放，但肉类和海鲜摊位通常休息，水果摊和部分蔬菜摊通常仍有营业。',
