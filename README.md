...
Flows target elements by `testID` (stable across languages) and run against `com.sfdye.pasarwhere.dev`, the dev build identity. Notifications and deep-link handling remain untestable in simulators.
