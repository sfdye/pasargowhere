...
EXTERNAL SERVICES
- data.gov.sg (https://data.gov.sg/datasets/d_bda4baa634dd1cc7a6c7cad5f19e2d68/view): the app downloads the public "Dates of Hawker Centre Closure" dataset from Singapore's National Environment Agency (NEA). No API key or account is required.
...
PasarGuru does not operate in a regulated industry. It is not affiliated with the Singapore Government, National Environment Agency (NEA), or Singapore Land Authority (SLA). The app links to the public data.gov.sg source and displays the required OneMap attribution; no private or protected third-party credentials are needed.
